...
apt-get -y install ipython python-pip python-dev couchdb libpq-dev python-couchdb python-couchdbkit python-mockito python-whoosh python-whoosh-doc python-ipy python-restkit '^python-requests.*$' python-tornado '^python-flask.*$' python-colorama python-colorama-whl python-psycopg2 python-psycopg2-doc
