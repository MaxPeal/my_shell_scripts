...
echo -e "Restart redis-server.service ...\n"
sudo systemctl stop redis-server.service
sudo systemctl start redis-server.service
sudo rm -f /tmp/redis.sock
sudo ln -f -s /var/lib/redis/redis.sock /tmp/redis.sock

# restart openvas-scanner.service
echo -e "Restart openvas-scanner.service ...\n"
sudo killall -9 openvassd 2>&1 >/dev/null
...
# restart openvas-manager.service
echo -e "Restart openvas-manager.service ...\n"
sudo killall -9 openvasmd 2>&1 >/dev/null
...
# restart greenbone-security-assistant.service
echo -e "Restart greenbone-security-assistant.service ...\n"
sudo killall -9 gsad 2>&1 >/dev/null
